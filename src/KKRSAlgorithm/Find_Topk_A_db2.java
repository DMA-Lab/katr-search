...
//                    }
    ...
    public ArrayList<Lower_bound> Top_k_db2(MyGraph g, int q, int q_SG, int k, int[] POI_Type, ArrayList<ArrayList<Integer>> SG, ArrayList<ArrayList<list>> List, POI[] POIList,
...
//        System.out.print("A_db2找到的最优路径的score为：");

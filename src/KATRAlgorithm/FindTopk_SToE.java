...
public class FindTopk_SToE {
    ...
    long time22 = 0;
    long time33 = 0;
    public ArrayList<Lower_bound> KATRFindTopk (MyGraph g, int q,int endIndex,int q_SG,int k,int[] POI_Type, ArrayList<ArrayList<Integer>> SG,ArrayList<ArrayList<list>> List , POI[] POIList,
        ...
        for (int i = 0; i < SG_n.size(); i++) {
            ...
            if (flag3 == true){
                ...
                if (min > (int)R){ //网格剪枝
                    ...
                    startTime1 = System.currentTimeMillis();
                    ArrayList<Lower_bound> allPath4 = Find_allPath(path7, List,POIList, a,q_BP,Min_w,BPList,PointMinBP,k);
                    endTime1 = System.currentTimeMillis();
                    time33 = time33 + endTime1 - startTime1;
